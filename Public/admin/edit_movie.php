            ...
            <div class="container">
                ...
                <div align="left">
                    <div class="form-group row">
                        ...
                        <input class="form-control col-sm-7" type="text" placeholder="Tên phim" name="movie[name]"
                               value="<?php echo $movie->name ?>" required>
                    ...
                    <div class="form-group row">
                        ...
                        <select class="form-control col-sm-7" name="movie[genre]" value="<?php echo $movie->genre ?>">
                            <option value="Kinh dị" <?php if ($movie->genre === 'Kinh dị') echo 'selected' ?>>Kinh dị
                            </option>
                            <option value="Khoa học viễn tưởng" <?php if ($movie->genre === 'Khoa học viễn tưởng') echo 'selected' ?>>
                                Khoa học viễn tưởng
                            </option>
                            <option value="Hành động" <?php if ($movie->genre === 'Hành động') echo 'selected' ?>>Hành
                                động
                            </option>
                            <option value="Hài" <?php if ($movie->genre === 'Hài') echo 'selected' ?>>Hài</option>
                            <option value="Tình cảm" <?php if ($movie->genre === 'Tình cảm') echo 'selected' ?>>Tình
                                cảm
                            </option>
                            <option value="Hoạt hình" <?php if ($movie->genre === 'Hoạt hình') echo 'selected' ?>>Hoạt
                                hình
                            </option>
                            <option value="Thần thoại" <?php if ($movie->genre === 'Thần thoại') echo 'selected' ?>>Thần
                                thoại
                            </option>
                            <option value="Tâm lý" <?php if ($movie->genre === 'Tâm lý') echo 'selected' ?>>Tâm lý
                            </option>
                    ...
                    <div class="form-group row">
                        ...
                        <input class="col-sm-7 form-control" type="text" placeholder="Nhà sản xuất"
                               name="movie[producer]" value="<?php echo $movie->producer ?>">
                    </div>
                    <div class="form-group row">
                        ...
                        <input class="col-sm-7 form-control" type="text" placeholder="Các diễn viên" name="movie[cast]"
                               value="<?php echo $movie->cast ?>">
                    </div>
                    <div class="form-group row">
                        <label class="offset-2 col-md-2 col-form-label">Thời lượng (phút): </label>
                        <input class="col-sm-7 form-control" type="number" placeholder="Thời lượng"
                               name="movie[duration]" value="<?php echo $movie->duration ?>">
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <option value="Sắp chiếu" <?php if ($movie->status === 'Sắp chiếu') echo 'selected' ?> >Sắp
                            chiếu
                        </option>
                        <option value="Đang chiếu" <?php if ($movie->status === 'Đang chiếu') echo 'selected' ?> >Đang
                            chiếu
                        </option>
                        <option value="Ngừng chiếu" <?php if ($movie->status === 'Ngừng chiếu') echo 'selected' ?> >
                            Ngừng chiếu
                        </option>
                        </select>
                    </div>
                    <div class="form-group row">
                        ...
                        <input class="col-sm-7 form-control" type="text" placeholder="Mô tả" name="movie[description]"
                               value="<?php echo $movie->description ?>">
                    </div>
                    <div class="form-group row">
                        <label class="offset-2 col-md-2 col-form-label">Giá vé cơ bản: </label>
                        <input class="col-sm-7 form-control" type="number" placeholder="Giá vé"
                               name="movie[ticket_price]" value="<?php echo $movie->ticket_price ?>" min="0">
                    </div>
                    <div class="form-group row">
